 ...
 * @author Aaik
 */
public class Locatie_selector extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Selecteer Locatie");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Locatie_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Locatie_selector().setVisible(true);
            }
        });
    }
